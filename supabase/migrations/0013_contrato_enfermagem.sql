-- Quarto contrato: TÉCNICO EM ENFERMAGEM (texto fiel enviado pela escola).
-- Obs.: Cláusula 9ª veio incompleta no original ("...instrumentos para.") — mantida fiel.
with c as (
  insert into public.contracts (title, description, active)
  values ('Contrato de Prestação de Serviços — Técnico em Enfermagem',
          'Contrato do curso Técnico em Enfermagem.', true)
  returning id
)
insert into public.contract_versions (contract_id, version, content_html, is_published)
select c.id, '1.0', $html$
<h2>CONTRATO DE PRESTAÇÃO DE SERVIÇO DO CURSO: TÉC. ENFERMAGEM</h2>
...
<p><strong>Cláusula 1ª</strong> - O CONTRATANTE contrata à CONTRATADA para realização de TÉCNICO EM ENFERMAGEM.</p>
...
<p><strong>Cláusula 9ª</strong> - Será por conta do CONTRATANTE o custo de aquisição de instrumentos para.</p>
<p><strong>Cláusula 10ª</strong> - O CONTRATANTE que não estiver em dia com os pagamentos das mensalidades não será permitida a execução das AULAS, após pagamento do débito poderá retomar suas aulas.</p>
<p><strong>Cláusula 11ª</strong> - A CONTRATADA reserva-se o direito de não oferecer o programa de ensino caso o número mínimo de alunos não seja atingido o mínimo de 20 alunos.</p>
<p><strong>Cláusula 12ª</strong> - Para receber a certificação do curso o CONTRATANTE declara cumprir todos os requisitos de documentação e educacionais estabelecidos pela CONTRATADA.</p>
<p><strong>Cláusula 13ª</strong> - O CONTRATANTE deverá executar todas as exigências educacionais, impostas pela DIREÇÃO, COORDENAÇÃO durante a execução das aulas, no caso de desobediência, à COORDENAÇÃO e/ou DIREÇÃO poderá expulsar o aluno, sem nenhum ônus a CONTRATADA.</p>
<p><strong>Cláusula 14ª</strong> - O CONTRATANTE deverá observar os princípios, comportamento e conduta éticos, morais, disciplinares e de respeito às normas de boa convivência coletiva e a qualquer integrante da COORDENAÇÃO, DIREÇÃO e ADMINISTRAÇÃO da CONTRATADA, sob pena de EXPULSÃO pela COORDENAÇÃO ou DIREÇÃO sem nenhum ônus a CONTRATADA.</p>
<p><strong>Cláusula 15ª</strong> - O CONTRATANTE autoriza o uso da sua imagem em todo e qualquer material entre fotos e documentos, para ser utilizado em Marketing da CONTRATADA em canais de comunicação e redes sociais.</p>
<p><strong>Cláusula 16ª</strong> - O CONTRATANTE no local e durante as aulas deverá utilizar trajes de acordo ao padrão impostos pela CONTRATADA, ficando a cargo da CONTRATADA a decisão de liberação do padrão nos casos em que achar necessário.</p>
<p><strong>Cláusula 17ª</strong> - O CONTRATANTE declara que todas as informações apresentadas a CONTRATADA na ficha de matrícula são verídicas e de inteira responsabilidade do CONTRATANTE.</p>
<p><strong>Cláusula 18ª</strong> - O CONTRATANTE terá um período de 45 (quarenta e cinco) dias após o termino do curso para sanar todas as pendências administrativa e/ou financeira, caso contrário será invalidado o período do tempo já cursado.</p>
<p><strong>Cláusula 19ª</strong> - As despesas da colação de grau como fotografias, filmagens, canudos, becas, é de inteira responsabilidade dos formandos.</p>
<p><strong>Cláusula 20ª</strong> - Será eleito o Fórum desta cidade, para dirimir quaisquer dúvidas, renunciando a qualquer outro por mais especial que seja.</p>
<p><strong>Cláusula 21ª</strong> - No final do curso, o aluno pagará 01 taxa de CERTIFICAÇÃO, no valor de R$ 500,00, que poderá ser dividida em 03 vezes.</p>
