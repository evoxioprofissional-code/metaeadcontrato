-- Substitui o conteúdo do contrato Supletivo pelo texto FIEL enviado pela escola.
update public.contract_versions cv
set content_html = $html$
<h2>CONTRATO DE PRESTAÇÃO DE SERVIÇOS DO CURSO: SUPLETIVO DO ENSINO MÉDIO</h2>
...
<p><strong>Cláusula 1ª</strong> - O CONTRATANTE contrata à CONTRATADA para realização de CURSO SUPLETIVO DO ENS. MÉDIO.</p>
...
<p><strong>Cláusula 8ª</strong> - Será por conta do CONTRATANTE o custo de deslocamento e alimentação o na execução das aulas teórica e práticas.</p>
<p><strong>Cláusula 9ª</strong> - O CONTRATANTE que não estiver em dia com os pagamentos das mensalidades não será permitida a execução das AULAS.</p>
...
<p><strong>Cláusula 17ª</strong> - O CONTRATANTE terá um período de 3 (três) meses após o término do curso para sanar todas as pendências administrativa e/ou financeira, caso contrário será invalidado o período do tempo já cursado.</p>
<p><strong>Cláusula 18ª</strong> - Será eleito o Fórum desta cidade, para dirimir quaisquer dúvidas, renunciando a qualquer outro por mais especial que seja.</p>
...
where cv.contract_id = c.id and c.title like '%Supletivo%';
